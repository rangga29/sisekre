...
let App = function() {
    ...
    return _createClass(e, [{
        ...
        value: function() {
            ...
            let e = document.getElementById("toastPlacement");
        ...
        value: function() {
            ...
            t && t.addEventListener("click", function() {
                "default" === e.getAttribute("data-sidebar") ? e.setAttribute("data-sidebar", "hidden") : e.setAttribute("data-sidebar", "hidden")
            });
            t = function() {
                window.innerWidth < 1040 ? e.setAttribute("data-sidebar", "hidden") : e.setAttribute("data-sidebar", "hidden")
            };
